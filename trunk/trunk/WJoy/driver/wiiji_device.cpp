...
#include "wiiji_device.h"

#include "wiimote_types.h"

#include <string.h>

const unsigned char WiijiDevice::hidDescriptorData[] = {
	// initial defaults
...
bool WiijiDevice::open()
{
    return m_Device.open(hidDescriptorData, sizeof(hidDescriptorData));
}
...
bool WiijiDevice::close()
{
    return m_Device.close();
}

WiijiDevice::WiijiDevice()
{
    memset(m_HIDStateData, 0, sizeof(m_HIDStateData));
}
